...
fn main() {
    ...
    // 物体着色器程序
    let obj_program = create_program("src/bin/senior_opengl_cubemap_refract/box_refract.vert", "src/bin/senior_opengl_cubemap_refract/box_refract.frag", &display);
    // skybox着色器程序
    let skybox_program = create_program("src/bin/senior_opengl_cubemap_refract/skybox.vert", "src/bin/senior_opengl_cubemap_refract/skybox.frag", &display);
